...
class Product(db.Model):
    ...
    image = db.Column(db.String(500), default='https://images.unsplash.com/photo-1523170335258-f5ed11844a49')    category_id = db.Column(db.Integer, db.ForeignKey('category.id'), nullable=False)
